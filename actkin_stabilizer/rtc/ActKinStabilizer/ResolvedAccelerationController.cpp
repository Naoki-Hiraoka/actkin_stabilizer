...
bool ResolvedAccelerationController::execResolvedAccelerationController(const GaitParam& gaitParam, double dt,
                                                                        std::shared_ptr<Object>& robot, std::vector<std::shared_ptr<Object> >& activeObjects) const{
